...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 24 Jan 2022 pada 07.28
...
(31, '1', 'dsasad', 111111, 'asdsas', '1642236913_316SySSD_400x400.jpg', '', NULL, NULL, NULL),
(83, '1', '', 0, 'BALALAA', '1642232600_toyotacayla.jpg', '', NULL, NULL, NULL),
(84, '1', '', 0, 'sadsasda', '1642232649_Biola.jpg', '', NULL, NULL, NULL),
(86, '1', '', 0, '123', '1642232781_316SySSD_400x400.jpg', '', NULL, NULL, NULL),
...
--
ALTER TABLE `barang`
  MODIFY `id_barang` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=90;

--
-- AUTO_INCREMENT untuk tabel `barang_pesanan`
--
ALTER TABLE `barang_pesanan`
  MODIFY `id_barang_pesanan` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=139;
